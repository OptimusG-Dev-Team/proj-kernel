...
static struct lp5521_led_pattern board_led_patterns[] = {
...
#if defined(CONFIG_MACH_APQ8064_GK_KR) || defined(CONFIG_MACH_APQ8064_GKATT) || defined(CONFIG_MACH_APQ8064_GV_KR) || defined(CONFIG_MACH_APQ8064_GKGLOBAL) || defined(CONFIG_MACH_APQ8064_OMEGAR_KR)
	...
	{
		/* ID_INCALL = 35  (GK - BACK LED is not used.)
		.r = mode17_red,
		.g = mode17_green,
		.b = mode17_blue,
...
static struct msm_thermal_data msm_thermal_pdata = {
	...
	.poll_ms = 1000,
	.limit_temp_degC = 90,
#if defined(CONFIG_MACH_APQ8064_GK_KR)|| defined(CONFIG_MACH_APQ8064_GKATT) || defined(CONFIG_MACH_APQ8064_GKGLOBAL) || defined(CONFIG_MACH_APQ8064_OMEGAR_KR)
