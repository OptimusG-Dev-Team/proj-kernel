...
/*
static struct msm_gpiomux_config apq8064_gsbi7_i2c_2ma_configs[] __initdata = {
	{
		.gpio      = 85,		// GSBI1 QUP I2C_CLK
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_i2c_config_sus,
			[GPIOMUX_ACTIVE] = &gpio_i2c_2ma_config,
		},
...
#endif
// kyle00.choi, 20130402, To feature out the modem. [END]
...
static struct gpiomux_setting mi2s_act_func_2_cfg = {
	.func = GPIOMUX_FUNC_2,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config apq8064_spkr_i2s_configs[] __initdata = {
	{
		...
		.settings = {
			[GPIOMUX_ACTIVE]    = &mi2s_act_func_2_cfg,
			[GPIOMUX_SUSPENDED] = &mi2s_sus_cfg,
		},
	},
	{
